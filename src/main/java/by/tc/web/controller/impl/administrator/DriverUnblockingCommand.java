...
import static by.tc.web.controller.impl.constant.ControllerConstants.ID;
import static by.tc.web.controller.impl.constant.ControllerConstants.TRUE_VALUE;

public class DriverUnblockingCommand implements ControllerCommand{
    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            boolean confirm =  driverService.unblock(idDriver);
            if (!confirm){
